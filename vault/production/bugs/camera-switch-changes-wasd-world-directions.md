...
Follow-up: Play walk is camera-relative again — [[feat-camera-aligned-walk|feat: Camera-aligned walk]]. `C` rotating W in Play is intended. Edit still has no player WASD.
