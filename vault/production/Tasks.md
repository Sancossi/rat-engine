...
- **Current sprint** — канбан `sprint: Sprint 10` (колонки Not started / In progress / In review / Blocked / Done). При смене `current: true` обновить фильтр `sprint == "Sprint N"` в `Task board.base`.
