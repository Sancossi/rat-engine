...
- **Current sprint** — канбан `sprint: Sprint 8` (колонки Not started / In progress / In review / Blocked / Done). При смене `current: true` обновить фильтр `sprint == "Sprint N"` в `Task board.base`.
...
Агент: Grep `status: In progress`, `In review`, `Blocked`, или `sprint: Sprint 8` в `vault/production/tasks/`.
