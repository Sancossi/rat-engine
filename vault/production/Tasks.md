...
- **Current sprint** — канбан `sprint: Sprint 12` (колонки Not started / In progress / In review / Blocked / Done). Спринт: [[Sprint 12 — Graph is Play truth]].
...
Агент: Grep `status: In progress`, `In review`, `Blocked`, или `sprint: Sprint 12` в `vault/production/tasks/`.
