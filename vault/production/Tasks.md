...
- **Current sprint** — канбан `sprint: Sprint 10` (колонки Not started / In progress / In review / Blocked / Done). Спринт закрыт; при следующем `current: true` обновить фильтр `sprint == "Sprint N"` в `Task board.base`.
...
Агент: Grep `status: In progress`, `In review`, `Blocked`, или `sprint: Sprint 10` в `vault/production/tasks/`.
