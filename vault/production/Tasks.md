...
- **Current sprint** — канбан `sprint: Sprint 11` (колонки Not started / In progress / In review / Blocked / Done). Спринт закрыт; при следующем `current: true` обновить фильтр `sprint == "Sprint N"` в `Task board.base`.
