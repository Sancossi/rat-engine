...
# Канальный город 5 — декор и скульптура

Intent: Вывески, кронштейны, знамёна и клипы ткани, светильники, три статуи; общий масштаб — четыре фигуры 1.2/1.8/2.8/4.0 м, изготовленные для проверки уже в первом этапе, без повторного производства.

Specification: [Утверждённый каталог](../../../docs/canal-city-catalog-spec.md).

Dependencies: [[feat-canal-city-04-mechanisms]]; Stride приёмка после A1.3/A1.4 в [[feat-stride-game-studio-authoring]].
...
Origin: [[feat-canal-city-01-foundation]]; [[feat-canal-city-04-mechanisms]].
Follow-up: [[feat-canal-city-06-library]].
