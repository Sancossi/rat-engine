...
Intent: opcode события (GPP Bytecode) постит в очередь [[feat-audio-play-queue-stub|feat: Audio play-queue stub]]. Зависит от audio stub; бэкенд звука не обязателен (null sink ок).
...
Follow-up: [[chore-playse-review-test-polish|chore: PlaySE review test polish]]
