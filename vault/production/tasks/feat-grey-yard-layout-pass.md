...
- Использовать мосты / рампы с граней / indoor dim, когда эти карточки закрыты: [[feat: Walkable bridges over open ground]], [[feat: Place ramp from clicked tile edge]], [[feat: Indoor volume dims the street]].
