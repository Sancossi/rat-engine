...
??????????? ??????? API milestone ???????? ?? ????????? ??????????? review: ?????? `bcd63d6`, Stride `4d336dac` (?????? pin). ??? ??? P2 ???????????????: native batch success/mixed failure ? ?????? Undo, ???? ??????? Sound ??? mutation, failed-readiness cleanup ?????? ???????? ? ??????????? fixtures. Resource run `build/mcp/resource-api-20260909-140442-982/result.json`: 101 ????? / 16 tools / 13 ????????? ??????? / 0 captures. Failed readiness `140534-001` ? ??????? session regression `140633-032` ??????. ???????? ?????? Release ???????????; main ??? ?? ????????, ????????? ???? ?? ?????.
