...
Depends: [[feat-event-graph-window-pages-and-conditions|feat: Event graph window pages and conditions]]. Origin: chat 2026-09-03. Related: [[feat-event-graph-model-and-compile|feat: Event graph model and compile]].
