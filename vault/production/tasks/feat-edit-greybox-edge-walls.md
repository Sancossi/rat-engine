...
Intent: авторинг и видимость рёбер в Edit/greybox плюс пример на `grey_yard`. Пресеты мини 0.45 / полная 1.6. Мышь во вьюпорте и undo height/edges — не эта карточка ([[feat-mouse-viewport-map-edit|feat: Mouse viewport map edit]], [[feat-edit-undo-redo|feat: Edit undo/redo command stack]]). Origin: [[feat-grid-edge-barriers|feat: Grid edge barriers]].
...
Depends: [[feat-grid-edge-barriers|feat: Grid edge barriers]]. Взято в [[Sprint 5 — Terrain and edge walls]].

Follow-up: [[feat-undo-height-and-edge-edits|feat: Undo height-grid and edge edits]]
Follow-up: [[feat-mouse-viewport-terrain-edit|feat: Mouse viewport terrain edit]]
