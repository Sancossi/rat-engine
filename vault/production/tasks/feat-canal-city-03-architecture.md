...
# Канальный город 3 — архитектура

Intent: Соборные стены/углы/контрфорсы/башня, дома, двери, витражи, карнизы/фронтоны/шпили, мавзолей/крипта/надгробные элементы.

Specification: [Утверждённый каталог](../../../docs/canal-city-catalog-spec.md).

Dependencies: [[feat-canal-city-02-passages]]; Stride приёмка после A1.3/A1.4 в [[feat-stride-game-studio-authoring]].
...
Origin: [[feat-canal-city-01-foundation]]; [[feat-canal-city-02-passages]].
Follow-up: [[feat-canal-city-04-mechanisms]].
