...
Intent: place/move/delete уже в [[feat-edit-undo-redo|feat: Edit undo/redo command stack]]; grow/shrink AABB, jumpable/vertical range и правки текста/страниц события всё ещё необратимы (YAGNI той карточки).
