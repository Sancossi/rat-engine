...
Реализация: `d989256`. Отдельная задача настройки, без запуска или закрытия игрового этапа/спринта. TOML и vault checks прошли; нативная проверка выполнения ролей идёт параллельно независимому ревью.
