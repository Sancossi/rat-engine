...
Depends: [[feat-cyrillic-in-texts-and-comments|feat: Cyrillic in texts and comments]]. Origin: [[Sprint 13 — Grey yard map pass]]. Related: [[feat-grey-yard-layout-pass|feat: Grey yard layout pass]].
