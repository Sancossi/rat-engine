...
Depends: [[feat-edit-submodes-terrain-objects-events|feat: Edit submodes terrain objects events]]. Origin: chat 2026-09-03. Related: [[feat-event-graph-window-pages-and-conditions|feat: Event graph window pages and conditions]].
