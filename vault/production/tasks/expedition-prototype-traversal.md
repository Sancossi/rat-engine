...
Blocked by: [[research-open-engine-foundation]]. Пользователь 2026-09-08 выбрал Stride. Перед продолжением требуется адаптировать архитектуру и срезы P1 к Stride; прежние CMake/rat-engine критерии ниже сохраняются как история и не разрешают автоматическое продолжение C++ реализации.
