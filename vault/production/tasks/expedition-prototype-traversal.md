...
- [ ] P1.1a: приблизить полевую камеру, улучшить экранный размер крысы и читаемость препятствий по замечанию пользователя (ориентиры Final Fantasy / Chrono Cross); проверить следование и глубину на реальных кадрах.
