...
Blocked by: [[feat-stride-source-foundation]]. Пользователь 2026-09-08 выбрал официальный upstream Stride. Перед продолжением требуется подготовить исходную основу и адаптировать архитектуру и срезы P1; прежние CMake/rat-engine критерии ниже сохраняются как история и не разрешают автоматическое продолжение C++ реализации.
