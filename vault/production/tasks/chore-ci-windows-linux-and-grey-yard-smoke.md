...
Intent: чистый checkout собирается без ручных шагов. Этап 0 [architecture roadmap](../../../docs/archive/cpp/architecture-roadmap.md). Взято в [[Sprint 7 — Engine architecture]].
