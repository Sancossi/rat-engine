...
Chat 2026-09-02 (play/author): полноценная многоуровневая карта. Выбор: **плита в воздухе** — верх = пол 2 этажа, низ = потолок 1; стены как сейчас, до плиты. Не парапет по верху Mini/Full забора (это позже, если понадобится). Авторинг: инструмент **Floor slab** — клик по клетке, плита на выбранной высоте (1.6 / 2.0 / своё Y), под ней пусто.
