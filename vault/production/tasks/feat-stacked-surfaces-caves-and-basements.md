...
Chat 2026-09-02 (play/author): полноценная многоуровневая карта. Кроме вертикальных `edge_barriers` — **верх ребра как пол** (ходить по стенке) и **потолок дома** (низ верхней плиты — solid). Плюс **террейн в воздухе**: клетка/плита без заполнения столба до Y=0.
