...
Origin: [[GDD]] Pause / save; [[s1-acceptance-playthrough-checklist|S1: Acceptance playthrough checklist]] (no file save UI). Взято в [[Sprint 9 — First playable loop]]. Related: [[s1-gamestate-switches-vars-inventory-position|S1: GameState switches/vars/inventory/position]].
