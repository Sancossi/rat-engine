...
# Канальный город 4 — механизмы и быт

Intent: Краны/клети/платформа с клипами, мебель, алтарь/гробы/саркофаг, шкаф/доска/святилище/контора, лавки/навесы/бельё/тара/телега/лодка/помпа.

Specification: [Утверждённый каталог](../../../docs/canal-city-catalog-spec.md).

Dependencies: [[feat-canal-city-03-architecture]]; Stride приёмка после A1.3/A1.4 в [[feat-stride-game-studio-authoring]].
...
Origin: [[feat-canal-city-01-foundation]]; [[feat-canal-city-03-architecture]].
Follow-up: [[feat-canal-city-05-decoration]].
