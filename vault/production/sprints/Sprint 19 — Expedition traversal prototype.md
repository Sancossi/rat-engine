...
В работе. Пользователь 2026-09-08 выбрал Stride и запросил исследование MCP и сопутствующих инструментов. P1 заблокирован сменой технической основы; далее нужна адаптация плана, а не продолжение прежних C++ срезов.
