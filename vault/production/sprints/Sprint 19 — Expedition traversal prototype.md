...
status: In Progress
dates: 2026-09-08
goal: Deliver the first standalone expedition traversal prototype on rat-engine
current: true
...
1. [[expedition-prototype-traversal]]: P1.1 запуск и спрайт → P1.2 движение → P1.3 сцены/мосты/перекрытия/упаковка.
...
В работе. Требуются независимое ревью, общий сценарий P1 и полная Release-проверка редактора.
