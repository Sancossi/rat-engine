...
| Collision world | Core | working | Fence bake + player cylinder vs segments; event overlap is circle vs AABB. Later crates/layers: [[feat: Field physics puzzles]], [[feat: Stacked surfaces caves and basements]]. Not ECS |
