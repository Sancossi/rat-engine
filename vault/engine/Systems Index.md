...
| Audio | Platform | stub | [[ADR-013 Audio backend miniaudio]]: `QueuedAudio` + `AudioSink`; tests swap Recording/Null; `EditorApp` owns sink and drains once per frame; clips `AssetId`; MiniaudioSink next card |
