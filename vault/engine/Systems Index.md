...
| Collision world | Core | planned | Bodies vs static map; player cylinder first. Later crates/plates/doors: [[feat: Field physics puzzles]]. Not ECS — [[research: Entity model ECS vs scene vs hybrid]] |
