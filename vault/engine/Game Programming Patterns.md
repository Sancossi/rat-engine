...
| State (FSM) | `locomotion_from` Idle/Walk/Jump/Fall/Climb; Climb владеет tick на Interact-rail ([[feat: MGS3 ladder climb]]) | Готово [[feat: Drive player physics from locomotion FSM]]; клипы — [[ADR-009 RE-like segmented character hierarchy]] |
