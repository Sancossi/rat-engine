...
7. Архитектура (Sprint 7): [[feat: SimulationSession unified tick]] → [[feat: Replay recording and checksum]] → [[feat: MapDocument and RuntimeMap compile]] → [[chore: Decompose EditorApp]]; ввод/звук: [[feat: Input rebind and gamepad]], [[research: Audio backend ADR]]; entity ADR: [[research: Entity model ECS vs scene vs hybrid]].
