...
- Полный P1: небольшой серый мост, маршрут под ним, подход наверх по пандусу/маршу, потолок и края; скрытие настила/стен и устойчивое следование. Проверяются также контекстные лестницы/порталы на разных высотах. Первый срез P1.1 ограничен плоским двором/стенами/героем; ярусные сценарии входят в P1.2/P1.3.
...
Прежние [[feat-walkable-bridges-over-open-ground]] и [[feat-voxel-3d-terrain-and-rotating-ramps]] завершены в C++ rat-engine. Их сценарии и геометрические требования полезны как история, но коллизии не переносятся автоматически в Stride. Новая реализация должна доказать размеры героя, опоры, перекрытия и связанные сценарии полного P1. Инженерные границы: [архитектура](../../../docs/rat-expedition-architecture.md).
