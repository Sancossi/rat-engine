"""Editable original prototype art. Rebuild with python assets/expedition/rat_sprite.py.
...
if __name__ == '__main__':
    target = Path(__file__).resolve().parents[2] / 'data/expedition/sprites/rat.png'
